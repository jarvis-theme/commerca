								...
								<li>
									<div class="product">
										...
										<div class="button-add-inner">
											<a onclick="window.location.href='{{slugProduk($myproduk)}}'" class="compare-hover" title="{{$myproduk->nama}}">  Lihat Detail</a>
										</div>
										</div>
		...
		<div class="row">		
			...
			<div class="tab-content row">
					...
					@foreach($produk as $key=>$myproduk)
						...
						<div class="col-xs-12 col-sm-6 col-lg-3 products-container">
							<div class="product">
								...
								<div class="button-add">
									<div class="button-add-inner">
										<a href="{{URL::to(slugProduk($myproduk))}}" class="compare-hover" title="{{$myproduk->nama}}">  Lihat Detail</a>
				...
				<div class="tab-pane animated animation-done rollIn" data-animation="rollIn" id="best">
					@foreach($featured as $key=>$myproduk)
						@if($key<4)
						<div class="col-xs-12 col-sm-6 col-lg-3 products-container">
							<div class="product">
								<a href="{{slugProduk($myproduk)}}" class="product-link clearfix">
