                ...
                <div class="section table-responsive">
                    <table class="my-cart">
                        ...
                        @if($setting->checkoutType==1)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('konfirmasiorder/'.$item->id) }}" title="Konfirmasi Order"><span class="icon-cart"></span></a>
                        ...
                        @elseif($setting->checkoutType==2)
                            ...
                            @if ($inquiry->count()==0)
                            <tr>
                                <td colspan="2"><span>Inquiry anda masih kosong.</span></td>
                            </tr>
                            @endif
                        @else
                            @foreach (list_order() as $item)
                            <tr>
                                ...
                                <td>
                                    @if($item->status!=2 || $item->status!=3)
                                    <a href="{{ url('konfirmasipreorder/'.$item->id) }}" title="Konfirmasi Order"><span class="icon-cart"></span></a>
                                    @else
                                    <span class="icon-checkmark"></span>
                                    @endif
                                </td>
