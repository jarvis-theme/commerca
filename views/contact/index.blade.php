                                    ...
                                    <form class="form-horizontal contact" action="{{url('kontak')}}" method="post">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-9">
                                                <input name="namaKontak" id="contactName" type="text" class="form-control" id="inputName" name="name"  placeholder="Nama" required>
                                            </div>
                                            <!-- <label for="inputName" class="col-xs-12 col-sm-3 required" >Nama</label> -->
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-9">
                                                <input name="emailKontak" id="email" type="text" class="form-control" id="inputEmail" name="email" placeholder="Email" required>
                                            </div>
                                            <!-- <label for="inputEmail" class="col-xs-12 col-sm-3 required">Email</label> -->
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12">
                                                <textarea class="form-control" name="messageKontak" placeholder="Isi pesan" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12">
