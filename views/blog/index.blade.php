                        ...
                        <div class="section-inner">
                            ...
                            @foreach(recentBlog() as $recent)
                                <li>
                                    ...
                                    <small class="dateblog">— diposting {{waktuTgl($recent->updated_at)}}</small>
                                </li>
                            @endforeach
                            </ul>
                        </div>
                        ...
                        <a href="{{blog_url($value)}}">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 desc-out">
                                <div class="description">
                                    ...
                                    <small class="timeblog"><span class="icon-calendar"></span> {{waktuTgl($value->updated_at)}} <span>&nbsp;&nbsp;</span></small>
                                    <br><br>               
