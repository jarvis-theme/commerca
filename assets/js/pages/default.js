define(['jquery','hoverIntent','dl_menu','waypoint','nouislider','carouFredSel','pretty_check','mixitup','jq_zoom','flexslider'], function($, hoverIntent, dlmenu, waypoint, noUiSlider, carouFredSel)
{
	return new function()
	{
		var self = this;
